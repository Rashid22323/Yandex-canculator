Предисловие:перез запусканием проекта прочитайте до конца README
...
Также  общение вычислителя и сервера вычислений теперь реализовано с помощью GRPC.(не правильно сделал, из-за этого проект не запускается)
